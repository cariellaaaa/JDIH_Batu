...
@section('css')
<link rel="stylesheet" href="{{ asset('css/Auth/staffdokumentasi.css') }}">
@endsection
        ...
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Monografi Hukum Lama</h1>
                </div>
                    ...
                    <table class="table table-striped table-sm" id="tableKatalog">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th scope="col">Tempat Penetapan</th>
                        ...
                        <tbody>
                            ...
                            @if(isset($draft->monografiHukum))
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{$draft->monografiHukum->nomor}}</td>
                                <td>{{$draft->monografiHukum->tahun}}</td>
                                <td>{{$draft->monografiHukum->judul}}</td>
                                <td>{{$draft->monografiHukum->edisi}}</td>
                                <td>{{$draft->monografiHukum->status_dokumen}}</td>
                                <td>{{date('d-m-Y', strtotime($draft->monografiHukum->tanggal_pengundangan))}}</td>
                                <td>{{$draft->monografiHukum->tempat_penetapan}}</td>
                                <td>{{$draft->status}}</td>
                                <td>
                                    <div class="mx-auto">
                                        <button type="button" class="button-trayek" data-bs-toggle="modal" data-bs-target="#trayek{{$draft->id}}">
                                            trayek
                                        </button>
                                        ...
                                        <a href="/dashboard/staffd/editkatalogprodukhukum/{{$draft->id}}" class="button-edit">edit</a>
                                        @endif

                                        @if($draft->status == 'diterima')
                                        <a href="/dashboard/staffd/readprodukhukum/{{$draft->id}}" class="button-lihat">lihat</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
