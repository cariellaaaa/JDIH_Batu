                    ...
                    <table class="table table-striped table-sm" id="tableUser">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">Dinas</th>
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="badge bg-info border-0 mx-auto" data-bs-toggle="modal"
                                                ...
                                                <form action="/dashboard/editUser/{{$user->id}}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <select class="form-select mt-2"
                                                            aria-label="Default select example" name="edit_role_id"
                                                            id="edit_role_id">
                                                            @foreach($role->skip(1) as $x)
                                                            <option value="{{$x->id}}"
                                                                {{ $user->role_id == $x->id ? 'selected' : null }}>
                                                                {{$x->role}}</option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select class="form-select mt-2"
                                                            aria-label="Default select example" name="edit_dinas_id"
                                                            id="edit_dinas_id">
                                                            @foreach($dinas as $x)
                                                            <option value="{{$x->id}}"
                                                                {{ $user->dinas_id == $x->id ? 'selected' : null }}>
                                                                {{$x->dinas}}</option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <input type="password"
                                                            class="form-control input @error('password') is-invalid @enderror mt-2"
                                                        ...
                                                        <input type="password"
                                                            class="form-control input @error('confirmPassword') is-invalid @enderror mt-2"
            ...
            <form action="/dashboard/addUser" method="post">
                <div class="modal-body">
                    ...
                    <input type="email" class="form-control input @error('email') is-invalid @enderror mt-2"
                        name="email" id="email" placeholder="nama@batukota.go.id" value="{{ old('email') }}">
                    ...
                    <input type="text" class="form-control input @error('name') is-invalid @enderror mt-2" name="name"
                    ...
                    <input type="number" class="form-control input @error('nip') is-invalid @enderror mt-2" name="nip"
                        id="nip" placeholder="195150707111007" value="{{ old('nip') }}">
                    ...
                    <select class="form-select mt-2" aria-label="Default select example" name="role_id" id="role_id">
                        @foreach($role->skip(1) as $x)
                        <option value="{{$x->id}}" {{ old('role_id') == $x->id ? 'selected' : null }}>{{$x->role}}
                        </option>
                        @endforeach
                    </select>
                    ...
                    <select class="form-select mt-2" aria-label="Default select example" name="dinas_id" id="dinas_id">
                        @foreach($dinas as $x)
                        <option value="{{$x->id}}" {{ old('dinas_id') == $x->id ? 'selected' : null }}>{{$x->dinas}}
                        </option>
                        @endforeach
                    </select>
