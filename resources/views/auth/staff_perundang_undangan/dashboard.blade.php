                    ...
                    <table class="table table-striped table-sm" id="tableStaffUndang">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td>{{$draft->admin->draft->dinas->dinas ?? 'Tidak Ada' }}</td>
                                <!-- Menampilkan nama dinas -->
                                ...
                                <td>
                                    <div class="mx-auto">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->admin->draft->status}} oleh
                                                                            {{$draft->admin->draft->draft_admins->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft
                                                                ->admin->draft->draft_admins->draft->keterangan_penolakan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->admin->draft->draft_admins->draft->keterangan_penolakan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->admin->status}} oleh
                                                                        {{$draft->admin->validated}}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                @if($draft->admin->draft->keterangan_penolakan !=
                                                                NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{ $draft->admin->draft->keterangan_penolakan }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @elseif($draft->kasubagUndang->status == 'ditolak oleh
                                                                kabag' || $draft->kasubagUndang->status == 'ditolak')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                                @endif
                                                            ...
                                                            <div class="col-2 text-start px-0">
                                                                ...
                                                                $draft->kasubagUndang->status == 'ditolak oleh kabag')
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->status}} oleh
                                                                            {{$draft->kasubagUndang->validated}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->keterangan}}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->status}}
                                                                            {{$draft->kasubagUndang->kabag->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @elseif($draft->kasubagUndang->kabag->status ==
                                                                'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->status ==
                                                                'ditolak' || $draft->kasubagUndang->kabag->status ==
                                                                'ditolak oleh sekda' ||
                                                                $draft->kasubagUndang->kabag->status == 'ditolak oleh
                                                                walikota')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col-2 text-start px-0">
                                                                ...
                                                                || $draft->kasubagUndang->kabag->status == 'ditolak oleh
                                                                sekda' || $draft->kasubagUndang->kabag->status ==
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->status}}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->status}}
                                                                            oleh
                                                                            {{$draft->kasubagUndang->kabag->validated}}
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->keterangan_penolakan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->status}}
                                                                            oleh
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->kasubagUndang->kabag->keterangan_penolakan
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->status ==
                                                                'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->status}}
                                                                        oleh
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->validated}}
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                                ...
                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'ditolak' ||
                                                                $draft->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'ditolak oleh walikota')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'diterima')
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                        oleh
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'diterima')
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                @if(isset($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->walikota_id))
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                        oleh
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'diterima')
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">
                                                                            {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}}
                                                                        oleh
                                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                        ...
                                        <a href="/dashboard/staffu/editprodukhukum/{{$draft->id}}"
                                            class="badge bg-info border-0 text-decoration-none">edit</a>
                                        @endif

                                        @if($draft->status == 'diterima')
                                        <a href="/dashboard/staffu/readprodukhukum/{{$draft->id}}"
