                    ...
                    <table class="table table-striped table-sm" id="tableSKPD">
                        ...
                        <tbody class="text">
                            ...
                            <tr>
                                ...
                                <td>{{$draft->judul}}</td>
                                <td>{{ $draft->dinas->dinas ?? 'Tidak Ada' }}</td> <!-- Menampilkan nama dinas -->
                                ...
                                <td>
                                    <div class="mx-auto">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->status}} oleh
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->validated ??''}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->keterangan != NULL)
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                @if(isset($draft->draft_admins) &&
                                                                $draft->draft_admins->status == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{ $draft->draft_admins->keterangan }} </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->status ==
                                                                'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->status ==
                                                                'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->draft_admins->staffUndang->status}}
                                                                        oleh
                                                                        {{$draft->draft_admins->staffUndang->validated}}
                                                                    </div>
                                                                </div>
                                                                @if($draft->draft_admins->staffUndang->keterangan !=
                                                                NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{ $draft->draft_admins->staffUndang->keterangan }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->keterangan_penolakan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{ $draft->draft_admins->staffUndang->keterangan_penolakan }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                                ...
                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->status
                                                                == 'ditolak oleh kabag' ||
                                                                $draft->draft_admins->staffUndang->kasubagUndang->status
                                                                == 'ditolak')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->status}}
                                                                            oleh
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->status}}
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->keterangan_penolakan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->keterangan_penolakan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                                ...
                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->status
                                                                == 'ditolak' ||
                                                                $draft->draft_admins->staffUndang->kasubagUndang->kabag->status
                                                                == 'ditolak oleh sekda' ||
                                                                $draft->draft_admins->staffUndang->kasubagUndang->kabag->status
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->keterangan_penolakan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->status}}
                                                                            oleh
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->keterangan_penolakan
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status}}
                                                                        oleh
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->validated}}
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                                ...
                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'ditolak' ||
                                                                $draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'ditolak oleh walikota')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                == 'diterima')
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                        oleh
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                == 'diterima')
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->walikota_id))
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                        oleh
                                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                == 'diterima')
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan
                                                                != NULL)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                @if($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                == 'diterima')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #198754;"></i>

                                                                @elseif($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                == 'menunggu')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #ffc107;"></i>
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">
                                                                            {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                        ...
                                        <a href="/dashboard/skpd/readprodukhukum/{{$draft->id}}"
                                            class="badge bg-primary border-0 text-decoration-none">lihat</a>
                                        @endif

                                        @if($draft->status == 'ditolak')
                                        <a href="/dashboard/skpd/editprodukhukum/{{$draft->id}}"
                                        ...
                                        <button type="button" class="badge bg-danger border-0" data-bs-toggle="modal"
                                            data-bs-target="#deleteDraft{{$draft->id}}">
                                            delete
                                        </button>
                                        @endif
                                    </div>
                                    ...
                                    <!-- Modal Delete Draft -->
                                    <div class="modal fade " id="deleteDraft{{$draft->id}}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Delete Draft Produk
                                                        Hukum</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form action="/dashboard/skpd/deleteprodukhukum/{{$draft->id}}"
                                                    method="post">
                                                    @method('delete')
                                                    <div class="modal-body">
                                                        @csrf
