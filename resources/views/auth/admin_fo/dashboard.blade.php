                    ...
                    <table class="table table-striped table-sm" id="tableAdmin">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td>{{$draft->draft->dinas->dinas ?? 'Tidak Ada' }}</td> <!-- Menampilkan nama dinas -->
                                ...
                                <td>
                                    <div class="mx-auto">
                                        ...
                                        <div class="modal fade " id="trayek{{$draft->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft->status}} oleh
                                                                            {{$draft->draft->validated}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->draft->keterangan_penolakan}}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->staffUndang->status}} oleh
                                                                        {{$draft->staffUndang->validated}}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{ $draft->staffUndang->keterangan }} </p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                        ...
                                                        @if($draft->staffUndang !== null &&
                                                        $draft->staffUndang->kasubagUndang !== null &&
                                                        $draft->staffUndang->kasubagUndang->staff_undang_id !== null):
                                                        ?>
                                                        <!-- Kode ini hanya akan dieksekusi jika staff_undang_id ada -->
                                                        <div class="row border-top">
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    @if(isset($draft->staffUndang->kasubagUndang->status))
                                                                    @if($draft->staffUndang->kasubagUndang->status ==
                                                                    'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>
                                                                    @elseif($draft->staffUndang->kasubagUndang->status
                                                                    ==
                                                                    'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                    ...
                                                                    ==
                                                                    'ditolak oleh kabag' ||
                                                                    $draft->staffUndang->kasubagUndang->status ==
                                                                    'ditolak')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #dc3545;"></i>
                                                                    @endif
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                ...
                                                                                {{$draft->staffUndang->kasubagUndang->status}}
                                                                                oleh
                                                                                {{$draft->staffUndang->kasubagUndang->validated}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @if($draft->staffUndang->kasubagUndang->keterangan
                                                                    !=
                                                                    NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->keterangan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                                    ...
                                                                    @if($draft->staffUndang->keterangan_penolakan !=
                                                                    NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->status}}
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->validated}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @if($draft->staffUndang->kasubagUndang->keterangan_penolakan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->keterangan_penolakan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->status
                                                                    ==
                                                                    'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                    ...
                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->status
                                                                    == 'ditolak' ||
                                                                    $draft->staffUndang->kasubagUndang->kabag->status ==
                                                                    'ditolak oleh sekda' ||
                                                                    $draft->staffUndang->kasubagUndang->kabag->status ==
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->keterangan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->keterangan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->keterangan_penolakan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                ...
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->status}}
                                                                                oleh
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->validated}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->keterangan_penolakan
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->status
                                                                    == 'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    <p class="text-uppercase fw-bold mb-0">kepala dinas
                                                                    </p>
                                                                    <p class="mb-0">Keterangan :</p>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0 mb-1">
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->status}}
                                                                            oleh
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->validated}}
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                    == 'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                    ...
                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                    == 'ditolak' ||
                                                                    $draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                    == 'ditolak oleh walikota')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #dc3545;"></i>
                                                                    @endif
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status
                                                                    == 'diterima')
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->keterangan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->keterangan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                    == 'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0 mb-1">
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}}
                                                                            oleh
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->validated}}
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                                    @endif
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status
                                                                    == 'diterima')
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-1"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->keterangan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    @if(isset($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->walikota_id))
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                    == 'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-0"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}}
                                                                            oleh
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->validated}}
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                                    @endif
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status
                                                                    == 'diterima')
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan
                                                                    != NULL)
                                                                    <div class="row">
                                                                        <div class="col-1 pe-0">
                                                                            <i class="fa-solid fa-angle-right"></i>
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->keterangan}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                            ...
                                                            <div class="row border-top">
                                                                <div class="col-1 px-0">
                                                                    ...
                                                                    @if($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                    == 'diterima')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #198754;"></i>

                                                                    @elseif($draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status
                                                                    == 'menunggu')
                                                                    <i class="fa-solid fa-circle"
                                                                        style="color: #ffc107;"></i>
                                                                ...
                                                                <div class="col text-start ps-0">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p class="mb-0"
                                                                                style="text-align: justify;">
                                                                                {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}}
                                                                            oleh
                                                                            {{$draft->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->validated}}
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                                                    @endif
                                            ...
                                            @if($draft->status == 'menunggu')
                                            <a href="/dashboard/admin/readprodukhukum/{{$draft->id}}"
