...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/katalogmonografihukum') ? 'active' : '' }}" aria-current="page" href="/dashboard/katalogmonografihukum">
                    <span class="align-text-bottom"><i class="fa-solid fa-table-columns"></i></span>
                    Katalog Monografi Hukum
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/staffd/addprodukhukum') ? 'active' : '' }}" aria-current="page" href="/dashboard/staffd/addprodukhukum">
                    <span class="align-text-bottom"><i class="fa-solid fa-plus"></i></span>
                    Tambah Peraturan Perundang-Undangan
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/staffd/addmonografihukum') ? 'active' : '' }}" aria-current="page" href="/dashboard/staffd/addmonografihukum">
                    <span class="align-text-bottom"><i class="fa-solid fa-plus"></i></span>
                    Tambah Monografi Hukum
                </a>
            </li>
            @endcan
