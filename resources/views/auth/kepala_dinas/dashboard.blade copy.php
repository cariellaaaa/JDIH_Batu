                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                @if(optional($draft->kabag)->kasubagUndang &&
                                                                optional($draft->kabag->kasubagUndang)->staffUndang &&
                                                                optional($draft->kabag->kasubagUndang->staffUndang)->admin
                                                                &&
                                                                optional($draft->kabag->kasubagUndang->staffUndang->admin->draft)->draft_admins
                                                                &&
                                                                optional($draft->kabag->kasubagUndang->staffUndang->admin->draft->draft_admins)->keterangan_penolakan)
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    </div>
                                                        ...
                                                        <div class="row border-top">
                                                            <div class="col-1 px-0">
                                                                ...
                                                                oleh kabag' || $draft->kabag->kasubagUndang->status ==
                                                                'ditolak')
                                                                <i class="fa-solid fa-circle"
                                                                    style="color: #dc3545;"></i>
                                                                @endif
                                                            ...
                                                            <div class="col-2 text-start px-0">
                                                                ...
                                                                || $draft->kabag->kasubagUndang->status == 'ditolak oleh
                                                                kabag')
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kabag->kasubagUndang->status}}
                                                                            {{$draft->kabag->kasubagUndang->kabag->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->kabag->kasubagUndang->keterangan_penolakan
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-1" style="text-align: justify;">
                                                                            {{$draft->kabag->status}} oleh
                                                                            {{$draft->kabag->kepalaDinas->sekda->validated}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                @if($draft->kabag->keterangan_penolakan != NULL)
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col-2 text-start px-0">
                                                                @if(isset($draft->status))
                                                                @if($draft->status == 'menunggu' || $draft->status ==
                                                                'ditolak oleh sekda')
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        {{$draft->sekda->status}} oleh
                                                                        {{$draft->sekda->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0 mb-1">
                                                                        ...
                                                                        {{$draft->sekda->walikota->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
